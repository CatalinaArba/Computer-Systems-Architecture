...
extern exit, fprintf, fscanf, fopen, fclose, fread               ; tell nasm that exit exists even if we won't be defining it
...
segment data use32 class=data
    ...
    fd dd -1
    accmode db "r", 0
    filename db "vowels.txt"
    len equ 1
    ;text times len db 0
    buffer resb 100
    
    ;descrip_file_print dd -1
    format db "%s", 0
